...
const Expertise: React.FC = () => {
	...
	const expertiseAreas = [
		...
		},
		{
			...
			icon: <Award size={24} />,
			image:
				"https://images.unsplash.com/photo-1559027615-cd4628902d4a?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80",
		},
		{
			...
			icon: <Award size={24} />,
			image:
				"https://images.unsplash.com/photo-1488190211105-8b0e65b80b4e?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80",
		},
		{
			title: "Forum & Wiki Websites",
			description:
				"Community-driven platforms for discussions and collaboration.",
			icon: <Award size={24} />,
			image:
		...
		},
		{
			...
			icon: <Award size={24} />,
			image:
				"https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80",
		},
	];
